function [fechaInicial, fechaFinal] = plotCombinedIEEE_rango(dataTable, xColumn, yColumns, yUnits, yLabels, colors, ylabelText, xlabelText, legendLocation, titleText)
    ...
    % Dibuja líneas punteadas para representar los requerimientos
    line([min(xNumeric), max(xNumeric)], [requirement1, requirement1], 'LineStyle', '--', 'Color', 'k', 'DisplayName', ['Requirement C/N (' num2str(requirement1) ' dB)']);
    line([min(xNumeric), max(xNumeric)], [requirement2, requirement2], 'LineStyle', '--', 'Color', 'b', 'DisplayName', ['Requirement C/No (' num2str(requirement2) ' dBHz)']);
    line([min(xNumeric), max(xNumeric)], [requirement3, requirement3], 'LineStyle', '--', 'Color', 'g', 'DisplayName', ['Requirement Eb/No (' num2str(requirement3) ' dB)']);
